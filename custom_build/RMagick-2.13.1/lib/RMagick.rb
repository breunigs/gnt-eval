...
class Image
    ...
    # auskommentiert weil RMagick sonst nicht läuft. *Eigentlich* sollte
    # das mit ImageMagick 6.4.4 klappen, tut es aber nicht. Siehe auch
    # http://www.42.mach7x.com/2010/03/18/undefined-method-remap-for-class-magickimage/
