...
Seee::Application.configure do
  ...
  config.assets.precompile += %w(js-yaml.min.js json2yaml.js formeditor.js ace/*.js excanvas.js visualize.jQuery.js correlate.js aceify-textareas.js viewer_count.js hitme_comment_preview.js)
