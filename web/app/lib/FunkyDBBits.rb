...
module FunkyDBBits
  ...
  def table_exists?(table)
    warn "DEPRECATED: FunkyDBBits.table_exists? Use ResultTools.instance.table_exists? instead"
  ...
  def query_single_table(f, h, t, additional = '', cache = true)
    warn "DEPRECATED: FunkyDBBits.query_single_table Use ResultTools.instance instead"
