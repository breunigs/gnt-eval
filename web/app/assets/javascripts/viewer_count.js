// give oneself random username, unless it has been defined before
if(typeof ident === 'undefined')
  var ident = Math.random().toString(36).substring(2,11);

// these have been defined in the viewer so the links may be generated
// only run if ping and ping urls are defined
if(typeof ping !== 'undefined' && typeof unping !== 'undefined') {
  // using Rails
...
function usernameValid() {
  return getCookie("username") !== null && getCookie("username") !== "";
}

function getUsernameCookie() {
  return usernameValid() ? getCookie("username") : ident;
}
