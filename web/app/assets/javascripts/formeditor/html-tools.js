...
FormEditor.prototype.createTranslateableTextArea = function(path) {
  ...
  if($.isArray(texts)) {
    ...
    this.createActionLink("$F().untranslatePath($(this).parent().attr('id'), this)", "« Unify (no localization)");
...
FormEditor.prototype.createLangTextBoxGenderized = function(path, lang) {
  ...
  this.createActionLink("$F().ungenderizePath($(this).parent().attr('id'), this)", "« no gender");
